...
namespace Trener
{
    ...
    public static class AllStrikes
    {
        ...
        public static PunchClass jab = new PunchClass(1, "1", @"Sounds\punches\1-sound.mp3");
        public static PunchClass cross = new PunchClass(2, "2", @"Sounds\punches\2-sound.mp3");
        public static PunchClass lead_hook = new PunchClass(3, "3", @"Sounds\punches\3-sound.mp3");
        public static PunchClass rear_hook = new PunchClass(4, "4", @"Sounds\punches\4-sound.mp3");
        public static PunchClass lead_upper = new PunchClass(5, "5", @"Sounds\punches\5-sound.mp3");
        public static PunchClass rear_upper = new PunchClass(6, "6", @"Sounds\punches\6-sound.mp3");

        public static PunchClass jab_b = new PunchClass(1, "1b", @"Sounds\punches\1b-sound.mp3");
        public static PunchClass cross_b = new PunchClass(2, "2b", @"Sounds\punches\2b-sound.mp3");
        public static PunchClass lead_hook_b = new PunchClass(3, "3b", @"Sounds\punches\3b-sound.mp3");
        public static PunchClass rear_hook_b = new PunchClass(4, "4b", @"Sounds\punches\4b-sound.mp3");
        public static PunchClass lead_upper_b = new PunchClass(5, "5b", @"Sounds\punches\5b-sound.mp3");
        public static PunchClass rear_upper_b = new PunchClass(6, "6b", @"Sounds\punches\6b-sound.mp3");



        public static class AllAdvice
        {
            public static AdviceClass hands_high = new AdviceClass(1, "Hands high", @"Sounds\tips\hands high-sound.mp3");

            public static AdviceClass basic_strikes_intro = new AdviceClass(1, "Single punches now", @"Sounds\workout_specific\intro-sound.mp3");
            public static AdviceClass two_p_combos = new AdviceClass(1, "2p combos now", @"Sounds\workout_specific\2p-sound.mp3");

            public static AdviceClass three_p_combos = new AdviceClass(1, "3p combos now", @"Sounds\workout_specific\3punchcombos-sound.mp3");
            public static AdviceClass three_p_combos_movement = new AdviceClass(1, "3p combos with movement now", @"Sounds\workout_specific\3punchcomboswithmovement-sound.mp3");
            public static AdviceClass three_p_combos_defence = new AdviceClass(1, "3p combos with defence now", @"Sounds\workout_specific\3punchcomboswithdefence-sound.mp3");


            public static AdviceClass defence_only = new AdviceClass(1, "Defence only", @"Sounds\workout_specific\basic_defence_intro-sound.mp3");
            public static AdviceClass add_counters = new AdviceClass(1, "Add counters", @"Sounds\workout_specific\basic_defence_counters-sound.mp3");

            public static AdviceClass move_only = new AdviceClass(1, "Movement only", @"Sounds\workout_specific\basic_movement_intro-sound.mp3");
            public static AdviceClass combos_after_moves = new AdviceClass(1, "Add combos after moves", @"Sounds\workout_specific\basic_movement_combos-sound.mp3");
            public static AdviceClass mix_it_up = new AdviceClass(1, "Mix it up", @"Sounds\workout_specific\basic_all-sound.mp3");


            public static AdviceClass headmovement_only = new AdviceClass(1, "Headmovement only", @"Sounds\workout_specific\headmovementonly-sound.mp3");



            public static AdviceClass moveyourhead = new AdviceClass(1, "Move your head", @"Sounds\tips\moveyourhead-sound.mp3");
            public static AdviceClass switchstance = new AdviceClass(1, "Switch your stance", @"Sounds\tips\switchstance-sound.mp3");
            public static AdviceClass highguard = new AdviceClass(1, "Highguard up", @"Sounds\tips\highguard-sound.mp3");
            public static AdviceClass keepmoving = new AdviceClass(1, "Keep moving", @"Sounds\tips\keepmoving-sound.mp3");
        ...
        {
            /* HEADMOVEMENT*/
            public static DefenceClass r_slip = new DefenceClass(1, "RSlip", @"Sounds\defence\r_slip-sound.mp3");
            public static DefenceClass l_slip = new DefenceClass(1, "LSlip", @"Sounds\defence\l_slip-sound.mp3");
            public static DefenceClass pull = new DefenceClass(1, "Pull", @"Sounds\defence\pull-sound.mp3");
            public static DefenceClass l_roll = new DefenceClass(1, "LRoll", @"Sounds\defence\l_roll-sound.mp3");
            public static DefenceClass r_roll = new DefenceClass(1, "RRoll", @"Sounds\defence\r_roll-sound.mp3");
            public static DefenceClass duck = new DefenceClass(1, "Duck", @"Sounds\defence\duck-sound.mp3");



            /* BLOK */
            public static DefenceClass l_catch = new DefenceClass(1, "LCatch", @"Sounds\defence\l_catch-sound.mp3");
            public static DefenceClass r_catch = new DefenceClass(1, "RCatch", @"Sounds\defence\r_catch-sound.mp3");
            public static DefenceClass l_parry = new DefenceClass(1, "LParry", @"Sounds\defence\l_parry-sound.mp3");
            public static DefenceClass r_parry = new DefenceClass(1, "RParry", @"Sounds\defence\r_parry-sound.mp3");

            /* BODY*/
            public static DefenceClass bodyblock = new DefenceClass(1, "BBlock", @"Sounds\defence\bodyblock-sound.mp3");
            public static DefenceClass r_bodyblock = new DefenceClass(1, "RBBlock", @"Sounds\defence\r_bodyblock-sound.mp3");
            public static DefenceClass l_bodyblock = new DefenceClass(1, "LBBlock", @"Sounds\defence\l_bodyblock-sound.mp3");


            /*shoulder roll*/
            public static DefenceClass s_roll = new DefenceClass(1, "SRoll", @"Sounds\defence\s_roll-sound.mp3");
        ...
        {
            /* steps */
            public static MoveClass step_right = new MoveClass(1, "StepR", @"Sounds\movements\step_right-sound.mp3");
            public static MoveClass step_left = new MoveClass(1, "StepL", @"Sounds\movements\step_left-sound.mp3");
            public static MoveClass step_back = new MoveClass(1, "StepB", @"Sounds\movements\step_back-sound.mp3");
            public static MoveClass step_forward = new MoveClass(1, "StepF", @"Sounds\movements\step_forward-sound.mp3");

            /*pivots*/
            public static MoveClass i_sidestep = new MoveClass(1, "ISStep", @"Sounds\movements\i_sidestep-sound.mp3");
            public static MoveClass o_sidestep = new MoveClass(1, "OSStep", @"Sounds\movements\o_sidestep-sound.mp3");
        ...
        {
            public static ExerciseClass pushups = new ExerciseClass(1,"Pushups", @"Sounds\exercises\pushups-sound.mp3");
            public static ExerciseClass burpees = new ExerciseClass(1, "Burpees", @"Sounds\exercises\burpees-sound.mp3");
            public static ExerciseClass squats = new ExerciseClass(1, "Squats", @"Sounds\exercises\squats-sound.mp3");
            public static ExerciseClass situps = new ExerciseClass(1, "Situps", @"Sounds\exercises\situps-sound.mp3");


            public static ExerciseClass shadowboxing = new ExerciseClass(1, "Shadowboxing", @"Sounds\exercises\shadowboxing-sound.mp3");
            public static ExerciseClass skippingrope = new ExerciseClass(1, "Skipping rope", @"Sounds\exercises\skippingrope-sound.mp3");
            public static ExerciseClass plank = new ExerciseClass(1, "Plank", @"Sounds\exercises\plank-sound.mp3");
...
public static class AllWorkouts
{
    ...
    AllCombos.CombosMoveAnd1p.c_sr_4}, 3);
            ...
            public static WorkoutClass longercombosWithAll_workout = new WorkoutClass(new List<ComboClass>
{
    ...
    AllCombos.CombosHMCounter1p.c_d_2
            ...
            public static WorkoutClass combobuild_workout = new WorkoutClass(new List<ComboClass> { AllCombos.CombosBuilder.Combo1.c_1, AllCombos.CombosBuilder.Combo1.c_1_ls, AllCombos.CombosBuilder.Combo1.c_1_ls_1, AllCombos.CombosBuilder.Combo1.c_1_ls_1_2, AllCombos.CombosBuilder.Combo1.c_1_ls_1_2_rs, AllCombos.CombosBuilder.Combo1.c_1_ls_1_2_rs_2, AllCombos.CombosBuilder.Combo1.c_1_ls_1_2_rs_2_3, AllCombos.CombosBuilder.Combo1.c_1_ls_1_2_rs_2_3_ls, AllCombos.CombosBuilder.Combo1.c_1_ls_1_2_rs_2_3_ls_3, AllCombos.CombosBuilder.Combo1.c_1_ls_1_2_rs_2_3_ls_3_2 }, 3);

            public static WorkoutClass combobuild_workout2 = new WorkoutClass(new List<ComboClass> { AllCombos.CombosBuilder.Combo2.c_p, AllCombos.CombosBuilder.Combo2.c_p_2, AllCombos.CombosBuilder.Combo2.c_p_2_3, AllCombos.CombosBuilder.Combo2.c_p_2_3_lr, AllCombos.CombosBuilder.Combo2.c_p_2_3_lr_3, AllCombos.CombosBuilder.Combo2.c_p_2_3_lr_3_2, AllCombos.CombosBuilder.Combo2.c_p_2_3_lr_3_2_rr, AllCombos.CombosBuilder.Combo2.c_p_2_3_lr_3_2_rr_2, AllCombos.CombosBuilder.Combo2.c_p_2_3_lr_3_2_rr_2_3 }, 3);
            public static WorkoutClass combobuild_workout3 = new WorkoutClass(new List<ComboClass> { AllCombos.CombosBuilder.Combo3.c_1, AllCombos.CombosBuilder.Combo3.c_1_2, AllCombos.CombosBuilder.Combo3.c_1_2_3b, AllCombos.CombosBuilder.Combo3.c_1_2_3b_rc, AllCombos.CombosBuilder.Combo3.c_1_2_3b_rc_3, AllCombos.CombosBuilder.Combo3.c_1_2_3b_rc_3_6, AllCombos.CombosBuilder.Combo3.c_1_2_3b_rc_3_6_lc, AllCombos.CombosBuilder.Combo3.c_1_2_3b_rc_3_6_lc_6, AllCombos.CombosBuilder.Combo3.c_1_2_3b_rc_3_6_lc_6_3 }, 3);
            public static WorkoutClass combobuild_workout4 = new WorkoutClass(new List<ComboClass> { AllCombos.CombosBuilder.Combo4.c_1, AllCombos.CombosBuilder.Combo4.c_1_ls, AllCombos.CombosBuilder.Combo4.c_1_ls_3b, AllCombos.CombosBuilder.Combo4.c_1_ls_3b_5, AllCombos.CombosBuilder.Combo4.c_1_ls_3b_5_2, AllCombos.CombosBuilder.Combo4.c_1_ls_3b_5_2_rs, AllCombos.CombosBuilder.Combo4.c_1_ls_3b_5_2_rs_2, AllCombos.CombosBuilder.Combo4.c_1_ls_3b_5_2_rs_2_6, AllCombos.CombosBuilder.Combo4.c_1_ls_3b_5_2_rs_2_6_4 }, 3);

            public static WorkoutClass switchhitting_workout = new WorkoutClass(new List<ComboClass>
{
    ...
    AllCombos.Combos1p.c_1b,           // Body jab
        AllCombos.CombosAdvice.c_stanceswitch,     // Basic strikes
            ...
            public static WorkoutClass pressurefighter_workout = new WorkoutClass(new List<ComboClass>
{
    ...
    AllCombos.Combos1p.c_1b,              // Body jab (close distance)
            ...
            public static WorkoutClass longrangefighter_workout = new WorkoutClass(new List<ComboClass>
{
    ...
    //AllCombos.CombosMove.c_move_back,   // Move back (maintain distance)
            ...
            public static WorkoutClass counterpuncher_workout = new WorkoutClass(new List<ComboClass>
{
    ...
    //AllCombos.CombosMove.c_step_back      // Step back
        ...
        public static class FitnessWorkouts
        {
            ...
            public static FitnessWorkoutClass cardio1 = new FitnessWorkoutClass(new List<ComboClass> { AllCombos.CombosExercise.c_shadowboxing, AllCombos.CombosExercise.c_pushups, AllCombos.CombosExercise.c_shadowboxing, AllCombos.CombosExercise.c_squats, AllCombos.CombosExercise.c_shadowboxing, AllCombos.CombosExercise.c_burpees }, 3, 60, 5);
        ...
        public static class FreestyleWorkouts
        {

            public static FitnessWorkoutClass work = new FitnessWorkoutClass(new List<ComboClass> { AllCombos.CombosExercise.c_pushups, AllCombos.CombosExercise.c_burpees, AllCombos.CombosExercise.c_squats, AllCombos.CombosExercise.c_situps }, 3, 10, 5);
